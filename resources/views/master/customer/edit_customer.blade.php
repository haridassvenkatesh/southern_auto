                                    ...
                                    <form class="dropzone dropzone-custom needsclick add-professors" id="customer">
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <div class="form-group">
                                                <label>GST NO</label>
                                                <input name="gst_no" id="gst_no" type="text" class="form-control" placeholder="GST No" value="<% $data['customer_details'][0]->gst_no %>">
                                             </div>
                                             <div class="form-group">
                                                <label>Phone No</label>
                                                <input name="phone_no1" id="phone_no1" type="text" class="form-control" placeholder="Phone No"  value="<% $data['customer_details'][0]->contact_no1 %>">
                                             </div>
                                             <div class="form-group">
                                                <label>Additional Phone No</label>
                                                <input name="phone_no2" id="phone_no2" type="text" class="form-control" placeholder="Additional Phone No" value="<% $data['customer_details'][0]->contact_no2 %>">
                                             </div>
                                             <div class="form-group">
                                                <label>Email Id</label>
                                                <input name="email_id1" id="email_id1" type="text" class="form-control" placeholder="Email Id" value="<% $data['customer_details'][0]->email1 %>">
                                             </div>
                                             <div class="form-group">
                                                <label>Additional Email Id</label>
                                                <input name="email_id2" id="email_id2" type="text" class="form-control" placeholder="Additional Email Id" value="<% $data['customer_details'][0]->email2 %>">
                                             </div>
                                             <label>Logo</label>
                                          ...
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <div class="form-group res-mg-t-15">
                                                <textarea name="address" id="address" placeholder="Address" style="height: 184px;"><% $data['customer_details'][0]->address %></textarea>
                                             </div>
                                             <label>Remarks</label>
                                             <div class="form-group res-mg-t-15">
                                                <textarea name="remarks" id="remarks" placeholder="Remarks" style="height: 184px;"><% $data['customer_details'][0]->remarks %></textarea>
                                             </div>
                                             <div class="form-group">
                                                <label>Status</label>
