                  ...
                  <div id="myTabContent" class="tab-content custom-product-edit">
                     <div class="product-tab-list tab-pane fade active in" id="description">
                                       ...
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <div class="form-group">
                                                <input name="customer_id" id="customer_id" type="hidden" class="form-control" value="<% $data['customer_details'][0]->customer_id %>">
                                                <label>Name <span style="color:red">*</span></label>
                                                <input name="customer_name" id="customer_name" type="text" class="form-control" placeholder="Customer Name" value="<% $data['customer_details'][0]->company_name %>">
                                             </div>
                                             <div class="form-group">
                                                <label>GST NO</label>
                                                <input name="gst_no" id="gst_no" type="text" class="form-control" placeholder="GST No" value="<% $data['customer_details'][0]->gst_no %>" onkeyup="ValidateGST(this);">
                                             </div>
                                             <div class="form-group">
                                                <label>Phone No <span style="color:red">*</span></label>
                                                <input name="phone_no1" id="phone_no1" type="text" class="form-control" placeholder="Phone No"  value="<% $data['customer_details'][0]->contact_no1 %>" onkeypress="return isNumberKey(event)">
                                             </div>
                                             <div class="form-group">
                                                <label>Additional Phone No</label>
                                                <input name="phone_no2" id="phone_no2" type="text" class="form-control" placeholder="Additional Phone No" value="<% $data['customer_details'][0]->contact_no2 %>" onkeypress="return isNumberKey(event)">
                                             </div>
                                             <div class="form-group">
                                                <label>Email Id <span style="color:red">*</span></label>
                                                <input name="email_id1" id="email_id1" type="text" class="form-control" placeholder="Email Id" value="<% $data['customer_details'][0]->email1 %>" onkeyup="ValidateEmailID(this);">
                                             </div>
                                             <div class="form-group">
                                                <label>Additional Email Id</label>
                                                <input name="email_id2" id="email_id2" type="text" class="form-control" placeholder="Additional Email Id" value="<% $data['customer_details'][0]->email2 %>" onkeyup="ValidateEmailID(this);">
                                             </div>
                                             <label>Logo</label>
                                          ...
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <div class="form-group res-mg-t-15">
                                                <textarea name="address" id="address" placeholder="Address" style="height: 165px;"><?= $data['customer_details'][0]->address ?></textarea>
                                             </div>
                                             <label>Remarks</label>
                                             <div class="form-group res-mg-t-15">
                                                <textarea name="remarks" id="remarks" placeholder="Remarks" style="height: 165px;"><?= $data['customer_details'][0]->remarks ?></textarea>
                                             </div>
                                             <div class="form-group">
                      ...
                      ?>
                                            ...
                                            <img src="<% $data['customer_details'][0]->image %>" style="width:100px;"/>
                                                      ...
                                                      <tr class="row1 commonItems" id="row_<?=$sno?>">
                                                         <td>
                                                            ...
                                                            <input id="contact_person_name_<?=$sno?>" name="commonItems[<?=$sno?>][contact_person_name]" type="text" class="form-control" placeholder="Contact Person"  value="<?=$detail->name?>"/>
                                                              ...
                                                              <input type="hidden" id="contact_person_id_<?=$sno?>" name="commonItems[<?=$sno?>][contact_person_id]" value="<?=$detail->contact_id?>"/>
                                                         </td>
                                                         ...
                                                         <td>
                                                            <input id="contact_person_phone_<?=$sno?>" name="commonItems[<?=$sno?>][contact_person_phone]" type="text" class="form-control" placeholder="Phone" value="<?=$detail->phone_no?>" onkeypress="return isNumberKey(event)" />
                                                            
                                                         </td>
                                                         <td>
                                                            <input id="contact_person_email_<?=$sno?>" name="commonItems[<?=$sno?>][contact_person_email]" type="text" class="form-control" placeholder="Email Id" value="<?=$detail->email?>" onkeyup="ValidateEmailID(this);" />
                                                         </td>
