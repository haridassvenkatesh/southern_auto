                  ...
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <ul class="breadcome-menu">
                           ...
                           <li><span class="bread-blod">Edit Designation</span>
                           </li>
                        </ul>
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                       ...
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <div class="form-group">
                                                <input name="designation_id" id="designation_id" type="hidden" class="form-control" value="<% $data['designation'][0]->designation_id %>">
                                                <label>Designation <span style="color:red"> * </span></label>
                                                <input name="designation_name" id="designation_name" type="text" class="form-control" value="<% $data['designation'][0]->name %>">
                                             </div>
                                             <div class="form-group res-mg-t-15">
                                                <label>Decription <span style="color:red"> * </span></label>
                                                <textarea name="design_description" id="design_description" placeholder="Description"> <?= $data['designation'][0]->description ?></textarea>
                                             </div>
                                          </div>
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <div class="form-group">
