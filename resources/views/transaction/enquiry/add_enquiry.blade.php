                  ...
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <ul class="breadcome-menu">
                           ...
                           <li><a href="">New Enquiry</a> <span class="bread-slash">/</span>
                           </li>
                           <li><span class="bread-blod">Created Enquiry</span>
                           </li>
                        </ul>
                     </div>
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                       ...
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <div class="form-group">
                                                ...
                                                <input name="status" id="status" type="hidden" class="form-control" value="4">
                                          ...
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <div class="form-group">
                                                ...
                                                <input name="enquiry_date" id="enquiry_date" type="text" class="form-control" placeholder="Enquiry date" readonly>
                                             </div>
                                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="project_name" id="project_name" placeholder="Project Name" style="height:100px"></textarea>
                                             </div>
                                             <div class="form-group res-mg-t-15">
                                                <label>Remark</label>
                                                <textarea name="remarks" id="remarks" placeholder="Remarks" style="height:100px"></textarea>
                                             </div>
                                          </div>
                                       </div>
                                                ...
                                                <table class="table table-bordered" id="tableId">
                                                   ...
                                                   <tbody id="commonSalesTable">
                                                      ...
                                                      <tr class="row1 commonItems" id="row_<?=$sno?>">
                                                         ...
                                                         <td>
                                                            <input id="quantity_<?=$sno?>" name="commonItems[<?=$sno?>][quantity]" type="text" class="form-control" placeholder="Quantity" onkeyup="commonAllTotal(<?= $sno ?>)"  onkeypress="return isNumber(event)"/>
                                                         </td>
                                                         <td>
                                                            <input id="price_<?=$sno?>" name="commonItems[<?=$sno?>][price]" type="text" class="form-control" value="0" placeholder="Price" onkeyup="commonAllTotal(<?= $sno ?>)"  onkeypress="return isNumber1(event)" />
                                                         </td>
                                                         <td>
                                                            <input id="amount_<?=$sno?>" name="commonItems[<?=$sno?>][amount]" type="text" class="form-control" value="0" placeholder="Amount" readonly />
                                                         </td>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="total_price" id="total_price" type="text" class="form-control" placeholder="Total Price" value="0"  readonly>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
										 <input name="discount_percentage" id="discount_percentage" type="hidden" class="form-control" placeholder="Discount %" onkeyup="discount()" value="0" >
										 <input name="discount_value" id="discount_value" type="hidden" class="form-control" value="0" placeholder="Discount Value" readonly>
<!--
                                       <div class="row">
                                          <div class="form-group">
                                             <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
...
<!--
                                       <div class="row">
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="discount_value" id="discount_value" type="text" class="form-control" value="0" placeholder="Discount Value" readonly>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
-->
                                       <div class="row">
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="gst_percentage" id="gst_percentage" type="text" class="form-control" placeholder="GST %" onkeyup="gst_percent()" onkeypress="return isNumber1(event)"  value="0">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="gst_value" id="gst_value" type="text" class="form-control" value="0" placeholder="GST Value" readonly>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="net_total" id="net_total" type="text" class="form-control" placeholder="Net Total" value="0" readonly>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
