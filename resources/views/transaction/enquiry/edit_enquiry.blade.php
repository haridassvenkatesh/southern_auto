                                       ...
                                       <div class="row">
                                         ...
                                         <div class="form-group">
                                               ...
                                               <div class="form-group">
                                                ...
                                                <input name="quotation_no" id="quotation_no" type="text" class="form-control" placeholder="Quotation No"  value="<% $quotation_no %>" readonly>
                                             </div>
                                               <div class="form-group">
...
<!--												 <input name="quoted_date1" id="quoted_date1" type="text" class="form-control" placeholder="Quoted Date"  value="<% $data['enquiry_details'][0]->quoted_date %>" disabled >-->
                                               ...
                                               <div class="form-group" id="convert_status3" style="display:<?= $display; ?>">
                                                <label>Project No <span style="color:red">*</span></label>
                                                   ...
                                                   ?>
                                                <input name="project_no" id="project_no" type="text" class="form-control" placeholder="Project No"  value="<% $project_no %>" readonly>
                                             </div>
