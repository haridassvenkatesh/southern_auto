										...
										<?php foreach($data['employee_list'] as $row){
											...
											<?php } ?>
                                                   ...
                                                   <div class="form-group">
                                                                    ...
                                                                    <input name="enquiry_date" id="enquiry_date" type="text" class="form-control" placeholder="Enquiry date" value="<% $data['enquiry_details'][0]->enquiey_date %>">
                                                                </div>
                                                       	...
                                                       	<div class="form-group">
																 ...
																 <div class="form-group res-mg-t-15">
                                                                    <textarea name="remarks" id="remarks" placeholder="Remarks"><% $data['enquiry_details'][0]->remarks %></textarea>
                                                                </div>
