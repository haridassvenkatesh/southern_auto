                                ...
                                <tr>    <td style="font-size:15px;"><b>Month</b></td>
                                    <td> <select id="drpCompountingMonth" onchange="changeGSTCompounding()" style="width:94%;">
                                                   ...
                                                   <?php $__currentLoopData = $data['Month']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select></td>   <td style="font-size:15px;"><b>Finanacial Year</b></td>
...
//					var it_name = data['itcategory']['a'][0]['name'];
//					var it_name = data['it'][0]['company_name'];
					var it_name = data['itcategory']['a'][0]['name'];
				}
...
feecollection=key.Actual_Fee;
                     ...
                     $('#tblIT_CONCERN tbody').append('<tr><td><table class="table table-bordered table_ITC" height="60px"><tr><td width="25%" style="font-size: 20px;">D/R</td><td width="25%" style="font-size: 17px;">' + dr + '</td></tr></table></td><td> <table class="table table-bordered table_ITC" height="60px"><tr><td width="25%" style="font-size: 20px;">CPC</td><td width="25%" style="font-size: 17px;">' + cpc + '</td></tr></table></td></tr> <tr><td> <table class="table table-bordered table_ITC" height="60px"><tr> <td width="25%" style="font-size: 20px;">Field</td> <td width="25%" style="font-size: 17px;">' + field + '</td></tr> </table> </td><td rowspan="2" colspan="2"><table class="table table-bordered table_ITC" height="138px"><tr><td style="text-align:left;font-size: 20px;    width: 25%;">FEE</td><td width="25%" style="font-size: 17px;">' + feecollection + '</td></tr><tr><td style="text-align:left;font-size: 20px;    width: 25%;">Collected</td><td width="25%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr><tr><td> <table height="60px"><tr></tr></table> </td></tr>');
...
feecollection=key.Actual_Fee;
   ...
   $('#tbltdsI tbody').append('<tr><td><table class="table table-bordered table_TDSI" height="60px"><tr><td width="25%" style="font-size: 20px;">T/C</td><td width="25%" style="font-size: 17px;">' + tc + '</td></tr></table></td><td> <table class="table table-bordered table_TDSI" height="60px"><tr><td width="25%" style="font-size: 20px;">T/P</td><td width="25%" style="font-size: 17px;">' + tp + '</td></tr></table></td></tr> <tr><td> <table class="table table-bordered table_TDSI" height="60px"><tr> <td width="25%" style="font-size: 20px;">R/F</td> <td width="25%" style="font-size: 17px;">' + rf + '</td></tr> </table> </td><td rowspan="2" colspan="2"><table class="table table-bordered table_TDSI" height="138px"><tr><td style="text-align:left;font-size: 20px;    width: 25%;">FEE</td><td width="25%" style="font-size: 17px;">' + feecollection + '</td></tr><tr><td style="text-align:left;font-size: 20px;    width: 25%;">Collected</td><td width="25%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr><tr><td> <table height="60px"><tr></tr></table> </td></tr>');
...
$('#tblgstregular tbody').append('<tr><td><table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">B/C</td><td width="25%" style="font-size: 17px;">' + BR + '</td></tr></table></td><td> <table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">GSTR 3B</td><td width="25%" style="font-size: 17px;">' + GSTR3B + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">T/A</td><td width="25%" style="font-size: 17px;">' + TA + '</td></tr></table></td><td> <table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">GSTR 1</td><td width="25%" style="font-size: 17px;">' + GSTR1 + '</td></tr></table></td></tr> <tr><td> <table class="table table-bordered table_gst" height="60px"><tr> <td width="25%" style="font-size: 20px;">Bank A/C</td> <td width="25%" style="font-size: 17px;">' + GSTR2 + '</td></tr> </table> </td><td rowspan="2" colspan="2"><table class="table table-bordered table_gst" height="138px"><tr><td style="text-align:left;font-size: 20px;    width: 25%;">FEE</td><td width="25%" style="font-size: 17px;">' + feecollection + '</td></tr><tr><td style="text-align:left;font-size: 20px;    width: 25%;">Collected</td><td width="25%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr><tr><td> <table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">Exp A/C</td><td width="25%" style="font-size: 17px;">' + GSTR3 + '</td></tr></table> </td></tr>');
