...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container-fluid">
            ...
            <?php if(Session::get('user_group_id') == 86 ): ?>
			<a class="brand" href="commonuser_dashboard" style="font-family: 'Righteous', cursive;">Auditor Panel</a> <?php endif; ?>
				...
				<ul class="nav pull-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a tabindex="-1" href="change_password_screen">Change Password</a>
							</li>
						</ul>
					</li>
				</ul>
 ...
 Dashboard</a> <?php endif; ?> <?php if(Session::get('user_group_id') == 86 ): ?>
						<a href="commonuser_dashboard"><i class="fa fa-tachometer" aria-hidden="true"></i>
 Dashboard</a> <?php endif; ?>
					</li>

					<?php if(Session::get('user_group_id') == 10 || Session::get('user_group_id') == 12 ||Session::get('user_group_id') == 11  ): ?>
					<li class="dropdown">
 ...
 Manage<b class="caret"></b></a>
						<ul class="dropdown-menu" id="Manage">
							...
							<?php if(Session::get('user_group_id') == 10 || Session::get('user_group_id') == 11 ): ?>
							<li>
						...
						<ul class="dropdown-menu" id="Mapping">
							...
							<li class="dropdown dropdown-submenu">
								...
								<ul class="dropdown-menu">
									...
									<!--                                    <li><a href="grand_gst_regular_report_test">Regular Test</a></li>-->
							...
							<li class="dropdown dropdown-submenu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">IT</a>
								<ul class="dropdown-menu">
									<li><a href="report_it_individual_year1">Individual</a></li>
									<li><a href="report_it_concern_year1">Concern (GST)</a></li>
								</ul>
							</li>
							<li class="dropdown dropdown-submenu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">TDS</a>
...
-->
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
                            <?php if(Session::get('user_group_id') == 10||Session::get('user_group_id') == 11||Session::get('user_group_id') == 12) { ?>
							<li>
                        ...
                        <a href="daily_report_details1">Daily Report</a>
                       
                    </li>
							
						</ul>
					</li>	<li>
						<?php if(Session::get('user_group_id') == 12 ): ?>
						<a href="aud_app_Bill_Received_GST"><i class="fa fa-tachometer" aria-hidden="true"></i> GST BR</a> <?php endif; ?> 
					</li>
					<!--
					<li class="dropdown">
...
-->
  <!--  <li>
                        <?php if(Session::get('user_group_id') == 10 ) { ?>
                        <a href="daily_report_details1"><i class="fa fa-tachometer" aria-hidden="true"></i> Daily Report</a>
                        <?php } ?>
                    </li>-->
<!--
                     ...
                     <li>
                        <?php if(Session::get('user_group_id') == 10 ) { ?>
                        <a href="daily_report_details"><i class="fa fa-tachometer" aria-hidden="true"></i> Daily Report</a>
                        <?php } ?>
                    </li>
-->
				</ul>
