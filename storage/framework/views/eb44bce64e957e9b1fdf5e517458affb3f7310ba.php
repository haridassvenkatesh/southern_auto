...
<script>
    function btn_click(year) {
        if (document.getElementById('hdnTax').value == 60) {
            window.location.href = "report_it_individual_year?Year=" + year + "&hdntax=" + $('#hdntax').val() + "&drpStatus=" + $('#drpStatus').val();
        } else if (document.getElementById('hdnTax').value == 61) {
            window.location.href = "report_it_concern_year?Year=" + year + "&hdntax=" + $('#hdntax').val() + "&drpStatus=" + $('#drpStatus').val();
        }
    }
