        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data['company'], function(i, key) {
                    ...
                    var tot = '<td>' + key.complete[0]['tot'] + '</td>';
                    ...
                    if ($('#drpStatus').val() == 2) {
                        ...
                        tot = '<td>' + (key.total - key.complete[0]['tot']) + '</td>';
                    ...
                    if ($('#hdntax').val() == 7) {
                        $("#tblCompany").append('<tbody><tr>' + Month + '' + totalCompany + '' + br + '' + ta + '' + gstr3b + '' + gstr1 + '' + gstr2 + '' + gstr3 + '' + tot + '' + cf + '' + fc + ' < /tr></tbody > ');
                    } else {
