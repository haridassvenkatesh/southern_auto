				...
				if (drpType == 8) {
					...
					$.each(data['company'], function(i, key) {
						...
						if (drpType == 60) {
							...
							$("#tblCompany tbody").append('<tr><td><b>' + (i + 1) + '</b></td><td style="text-align: left !important;">' + key.name + '</td><td style="text-align: left !important;">' + key.company_name + '</td><td>' + key.contact_no + '</td><td>' + key.dr + '</td><td>' + key.field + '</td><td>' + key.cpc + '</td><td>' + cf + '</td><td>' + key.fc + '</td></tr>');
						}
