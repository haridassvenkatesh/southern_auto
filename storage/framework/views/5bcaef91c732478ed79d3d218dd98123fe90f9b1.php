...
var month=(key.month)+1;
				...
				if (drpType == 8) {
					$("#tblCompany").append('<thead><tr><th rowspan=2>Month</th><th rowspan=2>Total Company</th><th rowspan=2>Bill Received</th><th rowspan=2>Tally Accounted</th><th rowspan=2>Bank A/C</th><th rowspan=2>EXP A/C</th><th rowspan=2>GSTR 4</th><th colspan=2>Fees Collection</th></tr><tr><th>Fee</th><th>Collected</th></tr></thead><tbody></tbody>');
					...
					$.each(data['company'], function(i, key) {
						...
						// } else {
							$("#tblCompany tbody").append('<tr><td><b><a onclick="btnComplete(' +month + ')" >' + key.monthName + '</b></a></td><td>' + key.total + '</td><td>' + br + '</td><td>' + ta + '</td><td>' + gstr2 + '</td><td>' + gstr3 + '</td><td>' + gstr1 + '</td><td>' + cf + '</td><td>' + fc + '</td></tr>');
						//}
					});
				} if (drpType == 71 || drpType == 72) {
					...
					$.each(data['company'], function(i, key) {
						...
						// } else {
							$("#tblCompany tbody").append('<tr><td><b><a onclick="btnComplete(' + month + ')" >' + key.monthName + '</a></b></td><td>' + key.total + '</td><td>' + tc + '</td><td>' + tp + '</td><td>' + rf + '</td><td>' + cf + '</td><td>' + fc + '</td></tr>');
						//}
					});
					...
					$.each(data['company'], function(i, key) {
						...
						if (drpType == 60) {
							$("#tblCompany tbody").append('<tr><td><b>' + (i + 1) + '</b></td><td style="text-align: left !important;">' + key.name + '</td><td>' + key.contact_no + '</td><td>' + key.dr + '</td><td>' + key.field + '</td><td>' + key.cpc + '</td><td>' + cf + '</td><td>' + key.fc + '</td></tr>');
						} else {
							$("#tblCompany tbody").append('<tr><td><b>' + (i + 1) + '</b></td><td style="text-align: left !important;">' + key.name + '</td><td style="text-align: left !important;">' + key.company_name + '</td><td>' + key.contact_no + '</td><td>' + key.dr + '</td><td>' + key.field + '</td><td>' + key.cpc + '</td><td>' + key.cf + '</td><td>' + key.fc + '</td></tr>');
						}
