                                    ...
                                    <form class="dropzone dropzone-custom needsclick add-professors" id="customer">
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <div class="form-group">
                                                <label>GST NO</label>
                                                <input name="gst_no" id="gst_no" type="text" class="form-control" placeholder="GST No" value="<?php echo e($data['customer_details'][0]->gst_no); ?>" onkeyup="ValidateGST(this);">
                                             </div>
                                             <div class="form-group">
                                                <label>Phone No <span style="color:red">*</span></label>
                                                <input name="phone_no1" id="phone_no1" type="text" class="form-control" placeholder="Phone No"  value="<?php echo e($data['customer_details'][0]->contact_no1); ?>" onkeypress="return isNumberKey(event)">
                                             </div>
                                             <div class="form-group">
                                                <label>Additional Phone No</label>
                                                <input name="phone_no2" id="phone_no2" type="text" class="form-control" placeholder="Additional Phone No" value="<?php echo e($data['customer_details'][0]->contact_no2); ?>" onkeypress="return isNumberKey(event)">
                                             </div>
                                             <div class="form-group">
                                                <label>Email Id <span style="color:red">*</span></label>
                                                <input name="email_id1" id="email_id1" type="text" class="form-control" placeholder="Email Id" value="<?php echo e($data['customer_details'][0]->email1); ?>" onkeyup="ValidateEmailID(this);">
                                             </div>
                                             <div class="form-group">
                                                <label>Additional Email Id</label>
                                                <input name="email_id2" id="email_id2" type="text" class="form-control" placeholder="Additional Email Id" value="<?php echo e($data['customer_details'][0]->email2); ?>" onkeyup="ValidateEmailID(this);">
                                             </div>
                                             <label>Logo</label>
