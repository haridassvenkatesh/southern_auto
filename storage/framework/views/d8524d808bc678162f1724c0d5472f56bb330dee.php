...
<div class="container-fluid">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="span12">
                                            ...
                                            <div class="span6">
                                                ...
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <input class="form-control date" id="date" ng-model="dob" name="date" placeholder="DD/MM/YYYY" type="text" readonly />
                                                    </div>
                                                </div>
 ...
 -->
                                        ...
                                        <div>
                                            <center>
                                                <button class="btn btn-inverse" type="button" ng-click="customer_update()"><i class="icon-refresh icon-white"></i> Update</button>
