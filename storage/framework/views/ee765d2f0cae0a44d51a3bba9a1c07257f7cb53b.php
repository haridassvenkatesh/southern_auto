		...
		$scope.submitform = function() {
			...
			$http.post('add_customer_information', formdata, {
				...
				if ($.isEmptyObject(data.error)) {
					...
					//                    if (data[0]['IT'] == 60) { // window.location.replace("customer_view_details"); // } else if (data[0]['IT'] == 61) { // window.location.replace("corresponding_customer_view"); // } // if (data[0]['IT'] == 71) { // window.location.replace("TDSViewCustomerIndividual"); // } else if (data[0]['IT'] == 72) { // window.location.replace("TDSViewCustomerConcern"); // }
					//console.log(data);
