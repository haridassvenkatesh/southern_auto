<div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href=""><img class="main-logo" src="<?php echo e(asset('/img/logo/logo.png')); ?>" alt="" /></a>
<!--                <strong><a href="index.html"><img src="<?php echo e(asset('/img/logo/logosn.png')); ?>" alt="" /></a></strong>-->
            </div>
