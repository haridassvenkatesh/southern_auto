        ...
        <div class="span12" id="content">
            <div class="row-fluid">
                <div class="block-content collapse in">
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                               <input type="text" id="name" name="name" value="<?= $data['Employee_Name'][0][0]->First_Name?>" disabled style="width: 100%!important;"/> <br/>
                        ...
                        <div class="span4">
                            <div class="control-group">
                                <label class="control-label" for="category">Phone No</label>
                                <div class="controls">
                                    <input type="text" id="date" name="date" value="<?= $data['Employee_Name'][0][0]->Phone_No1?>" disabled style="width: 100%!important;"/> <br/>
                    ...
                    <div class="row-fluid"><button id="btnBack" name="btnBack" class="btn btn-primary" onclick="btnBack()"> Back</button></div>
                        <div class="row-fluid">
                        <!-- block --> 
...
<input type="hidden" id="empid" name="empid" value="<?= $data['EmpID'] ?>">
<script>
    $('#date1').datepicker({
    changeMonth: true,
    changeYear: true,
...
function btnBack(){
   window.location.replace("daily_report_details1");
    ...
    function datechange(date){
        var EmpId=$('#empid').val();
        window.location.replace("daily_report_details_Company_wise?Empid="+EmpId+"&Date="+date);
    }
</script>
