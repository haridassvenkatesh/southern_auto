                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod"><a href="add_employee">Add Employee</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                       ...
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input name="email_id" id="email_id" type="text" class="form-control" placeholder="Email Id" onkeyup="ValidateEmailID(this);">
                                             </div>
                                          ...
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input name="dob" id="dob" type="text" class="form-control" placeholder="DD-MM-YYYY" readonly>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input name="doj" id="doj" type="text" class="form-control" placeholder="DD-MM-YYYY" readonly>
                                             </div>
                                             <div class="form-group res-mg-t-15">
                                                 <label>
                                                 Address <span style="color:red"> * </span>
                                                 </label>
                                                <textarea name="address" id="address" placeholder="Address" style="height: 100px;"></textarea>
                                             </div>
