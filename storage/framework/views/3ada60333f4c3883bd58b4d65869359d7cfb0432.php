...
<!--<script src="<?php echo e(asset('/js/vendor/modernizr-2.8.3.min.js')); ?>"></script>-->
    ...
    <script src="<?php echo e(asset('/js/icheck/icheck-active.js')); ?>"></script>
    <!-- plugins JS
		============================================ -->
...
<!--    <script src="<?php echo e(asset('/js/tawk-chat.js')); ?>"></script>-->
 ...
 <!-- data table JS
    ...
    <script src="<?php echo e(asset('/js/data-table/jspdf.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/data-table/jspdf.plugin.autotable.js')); ?>"></script>

  <!-- chosen JS
		============================================ -->
<script src="<?php echo e(asset('/js/chosen/chosen.jquery.js')); ?>"></script>
<script src="<?php echo e(asset('/js/chosen/chosen-active.js')); ?>"></script>
