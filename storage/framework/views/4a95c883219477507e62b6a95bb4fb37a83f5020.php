                                        ...
                                        <div class="span12">
                                            <div class="span6">
                                                <div class="control-group">
                                                    ...
                                                    <label class="control-label" for="category">GST Username<b style="color:red">*</b></label>
                                                    <div class="controls">
                                            ...
                                            <div class="span6">
                                                <div class="control-group">
                                                    ...
                                                    <label class="control-label" for="category">GST Password<b style="color:red">*</b></label>
                                                    <div class="controls">
                                                            ...
                                                            <table class="table table-bordered" id="tableId">
                                                                ...
                                                                <tbody>
                                                                    <tr ng-repeat="Proprietor in Proprietor_Details" class="controls">
                                                                        ...
                                                                        <td>
                                                                            <input type="text" name="name" ng-model="Proprietor.name" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="father_name" ng-model="Proprietor.father_name" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control date" name="dob" ng-model="Proprietor.dob" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="aathar" ng-model="Proprietor.aathar" />
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <table class="table table-bordered" id="tableId">
                                                                ...
                                                                <tbody>
                                                                    <tr ng-repeat="Partner in Partner_Details" class="controls">
                                                                        ...
                                                                        <td>
                                                                            <input type="text" name="name" ng-model="Partner.name" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="father_name" ng-model="Partner.father_name" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control date" name="dob" ng-model="Partner.dob" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="pan_no" ng-model="Partner.pan_no" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="aathar" ng-model="Partner.aathar" />
                                                                        </td>
                                                                        <td>
...
<script>
    ...
    app.controller("mycontroller", function($scope, $http) {
        ...
        $scope.cancel = function() {
            window.location.href = "concern_customer_view";
        }
