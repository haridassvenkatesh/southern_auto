                                                        ...
                                                        <table class="table table-bordered" id="tableId">
                                                            ...
                                                            <tbody>
                                                                <tr ng-repeat="Proprietor in Proprietor_Details" class="controls">
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control" name="dob" ng-model="Proprietor.dob" onclick="a()" placeholder="DD/MM/YYYY" />
                                                                    </td>
                                                                    <td>
                                                        ...
                                                        <table class="table table-bordered" id="tableId">
                                                            ...
                                                            <tbody>
                                                                <tr ng-repeat="Partner in Partner_Details" class="controls">
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control" name="name" ng-model="Partner.dob" placeholder="DD/MM/YYYY" onclick="a()" />
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="partner_pan" ng-model="Partner.pan_no" onclick="a()" />
                                                                    </td>
                                                                    <td>
