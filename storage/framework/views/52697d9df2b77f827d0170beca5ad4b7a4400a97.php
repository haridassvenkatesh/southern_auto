                                       ...
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                             <div class="form-group">
                                                <input name="enquiry_id" id="enquiry_id" type="hidden" class="form-control" value="<?php echo e($data['enquiry_id']); ?>" >
                                                <input name="company_name" id="company_name" type="hidden" class="form-control" value="<?php echo e($data['enquiry_details'][0]->company_id); ?>" >
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input name="contact_person_email_id" id="contact_person_email_id" type="text" class="form-control" placeholder="Email Id" value="<?php echo e($data['contact_person_email'][0]->email); ?>" readonly>
                                             </div>
                                             <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input name="enquiry_date" id="enquiry_date" type="text" class="form-control" placeholder="Enquiry date" value="<?php echo e($data['enquiry_details'][0]->enquiey_date); ?>" readonly>
                                             </div>
                                             <div class="form-group">
                                                <label>Reffered By</label>
                                                <input name="refered_by" id="refered_by" type="text" class="form-control" placeholder="Enquiry Refered By"  value="<?php echo e($data['enquiry_details'][0]->refered_by); ?>">
                                             </div>                                           
                                            <div class="form-group" id="convert_status4" style="display:<?= $display1; ?>">
                                                <label>Invoice No <span style="color:red">*</span></label>
                                                <input name="invoice_no" id="invoice_no" type="text" class="form-control" placeholder="Invoice No"  value="<?php echo e($data['enquiry_details'][0]->invoice_no); ?>">
                                             </div>
                                               <div class="form-group" id="convert_status5" style="display:<?= $display1; ?>">
                                                <label>Invoice Date <span style="color:red">*</span></label>
                                                <input name="invoice_date" id="invoice_date" type="text" class="form-control" placeholder="Invoice Date"  value="<?php echo e($data['enquiry_details'][0]->invoice_date); ?>" readonly>
                                             </div>
                                               <div class="form-group" id="convert_status6" style="display:<?= $display1; ?>">
                                                <label>Transporter <span style="color:red">*</span></label>
                                                <input name="transporter" id="transporter" type="text" class="form-control" placeholder="Transporter"  value="<?php echo e($data['enquiry_details'][0]->transporter); ?>">
                                             </div>
                                                 <div class="form-group" id="convert_status7" style="display:<?= $display1; ?>">
                                                <label>LR.No<span style="color:red">*</span></label>
                                                <input name="lr_no" id="lr_no" type="text" class="form-control" placeholder="LR.No"  value="<?php echo e($data['enquiry_details'][0]->lr_no); ?>">
                                             </div>
                                          </div>
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                         <div class="form-group">
                                               ...
                                               <div class="form-group">
                                                <label>Quoted Date <span style="color:red">*</span></label>
												 ...
												 if($data['enquiry_details'][0]->enquiry_status==4){
												  ...
												  <input name="quoted_date" id="quoted_date" type="text" class="form-control" placeholder="Quoted Date" readonly  value="<?php echo e($data['enquiry_details'][0]->quoted_date); ?>"  >
												<?php 
												 
												 } else{ ?>
												 
												 <input name="quoted_date" id="quoted_date" type="text" class="form-control" placeholder="Quoted Date" readonly value="<?php echo e($data['enquiry_details'][0]->quoted_date); ?>"  >
<!--												 <input name="quoted_date1" id="quoted_date1" type="text" class="form-control" placeholder="Quoted Date"  value="<?php echo e($data['enquiry_details'][0]->quoted_date); ?>" disabled >-->
                                               ...
                                               <div class="form-group" id="convert_status1" style="display:<?= $display; ?>">
                                                ...
                                                <input name="po_no" id="po_no" type="text" class="form-control" placeholder="PO No"  value="<?php echo e($data['enquiry_details'][0]->po_no); ?>">
                                             </div>
                                               <div class="form-group" id="convert_status2" style="display:<?= $display; ?>">
                                                <label>PO Date <span style="color:red">*</span></label>
                                                <input name="po_date" id="po_date" type="text" class="form-control" placeholder="PO Date"  value="<?php echo e($data['enquiry_details'][0]->po_date); ?>" readonly>
                                             </div>
                                               ...
                                               <div class="form-group" id="convert_status8" style="display:<?= $display; ?>">
                                                ...
                                                <input name="delivery_date" id="delivery_date" type="text" class="form-control" placeholder="Delivery Date"  value="<?php echo e($data['enquiry_details'][0]->delivery_date); ?>" readonly>
                                             </div>
											
											   <div class="form-group res-mg-t-15">
                                                <label>Project Name <span style="color:red">*</span></label>
                                                <textarea name="project_name" id="project_name" placeholder="Project Name" style="height:100px;"><?php echo e($data['enquiry_details'][0]->project_name); ?></textarea>
                                             </div>
                                              <div class="form-group res-mg-t-15">
                                                <label>Remark</label>
                                                <textarea name="remarks" id="remarks" placeholder="Remarks" style="height:100px;"><?php echo e($data['enquiry_details'][0]->remarks); ?></textarea>
                                             </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="total_price" id="total_price" type="text" class="form-control" placeholder="Total Price" value="<?php echo e($data['enquiry_details'][0]->amo_with_out_tax); ?>" readonly>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <input name="discount_percentage" id="discount_percentage" type="hidden" class="form-control" placeholder="Discount %" onkeyup="discount()" value="<?php echo e($data['enquiry_details'][0]->discount); ?>" >
                                       <input name="discount_value" id="discount_value" type="hidden" class="form-control" placeholder="Discount Value"  value="<?php echo e($data['enquiry_details'][0]->discount_value); ?>" readonly>
                                       <!--
                                          <div class="row">
                                           <div class="form-group">
                                                                                       <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                                       ...
                                                                                       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                                           <div class="form-select-list">
                                                                                               <input name="discount_percentage" id="discount_percentage" type="text" class="form-control" placeholder="Discount %" onkeyup="discount()" value="<?php echo e($data['enquiry_details'][0]->discount); ?>" >
                                                                                           </div>
                                                                                       </div>
                                          </div>
                                                                                   </div>
                                       ...
                                       <!--
                                          <div class="row">
                                          	 <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                                            <div class="form-select-list">
                                                                                                <input name="discount_value" id="discount_value" type="text" class="form-control" placeholder="Discount Value"  value="<?php echo e($data['enquiry_details'][0]->discount_value); ?>" readonly>
                                                                                            </div>
                                                                                        </div>
                                          	</div>
                                                                                    </div>
                                       ...
                                       <div class="row">
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="gst_percentage" id="gst_percentage" type="text" class="form-control" placeholder="GST %" onkeyup="gst_percent()" value="<?php echo e($data['enquiry_details'][0]->gst_percent); ?>">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="gst_value" id="gst_value" type="text" class="form-control" placeholder="GST Value" value="<?php echo e($data['enquiry_details'][0]->gst_value); ?>" readonly>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="form-group">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="form-select-list">
                                                   <input name="net_total" id="net_total" type="text" class="form-control" placeholder="Net Total" value="<?php echo e($data['enquiry_details'][0]->net_value); ?>"  readonly>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
