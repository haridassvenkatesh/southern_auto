										...
										<?php foreach($data['employee_list'] as $row){
											...
											<?php } ?>
                                                   ...
                                                   <div class="form-group">
                                                                    ...
                                                                    <input name="enquiry_date" id="enquiry_date" type="text" class="form-control" placeholder="Enquiry date" value="<?php echo e($data['enquiry_details'][0]->enquiey_date); ?>">
                                                                </div>  
                                                       	...
                                                       	<div class="form-group">
																 ...
																 <div class="form-group res-mg-t-15">
                                                                    <textarea name="remarks" id="remarks" placeholder="Remarks"><?php echo e($data['enquiry_details'][0]->remarks); ?></textarea>
                                                                </div>
                                                ...
                                                <select name="status" id="status" class="form-control chosen-select" placeholder="Status"  >
                                                 ...
                                                 <?php foreach($data['enquiry_status'] as $row){
													$selected='';
											if($row->status_id == $data['enquiry_details'][0]->enquiry_status)
												$selected='selected';
												?>
											...
											<?php } ?>
                                                      ...
                                                      <tr class="row1 commonItems" id="row_<?=$sno?>">
                                                         ...
                                                         <td>
                                                            <input id="quantity_<?=$sno?>" name="commonItems[<?=$sno?>][quantity]" type="text" class="form-control" placeholder="Quantity" onkeyup="commonAllTotal(<?= $sno ?>)" value="<?=$detail->qty?>" />
                                                         </td>
                                                         <td>
                                                            <input id="price_<?=$sno?>" name="commonItems[<?=$sno?>][price]" type="text" class="form-control" placeholder="Price" onkeyup="commonAllTotal(<?= $sno ?>)" value="<?=$detail->price?>" />
