                                ...
                                <fieldset>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="span6">
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <input type="text" name="aathar_no" placeholder="Aadhaar No" ng-model="aathar_no" ng-change="audharvalidation()" />
...
<script>
    ...
    app.controller("mycontroller", function($scope, $http) {
        ...
        $scope.audharvalidation = function() {
            ...
            if (regaudhar.test($scope.aathar_no) == false) {
