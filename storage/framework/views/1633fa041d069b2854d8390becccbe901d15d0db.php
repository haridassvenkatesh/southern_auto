		...
		$.ajax({
			...
			success: function(data) {
				...
				$.each(data, function(i, key) {
					...
					if ($("#drpType").val() == 8) {
						body += '<tr><td style="text-align:center"><b>' + sno + '</b></td><td style="text-align:center"><b>' + key.First_Name + '</b></td><td>' + key.circle + '</td><td style="text-align:center">' + monthNames[pc_month - 1] + '</td><td style="text-align:center">' + key.pc_year + '</td><td style="text-align:center">' + BR + '</td><td style="text-align:center">' + TA + '</td><td style="text-align:center">' + GSTR2 + '</td><td style="text-align:center">' + GSTR3 + '</td><td style="text-align:center">' + GSTR4 + '</td><td style="text-align:center">' + fee + '</td><td style="text-align:center">' + FC + '</td></tr>';
					}
					if ($("#drpType").val() == 60) {
					...
					if ($("#drpType").val() == 71) {
						body += '<tr><td style="text-align:center"><b>' + sno + '</b></td><td style="text-align:center"><b>' + key.First_Name + '</b></td><td style="text-align:center">' + monthNames[pc_month - 1] + '</td><td style="text-align:center">' + key.pc_year + '</td><td style="text-align:center">' + TC + '</td><td style="text-align:center">' + TP + '</td><td style="text-align:center">' + RF + '</td><td style="text-align:center">' + fee + '</td><td style="text-align:center">' + FC + '</td></tr>';
					}
					if ($("#drpType").val() == 61) {
						body += '<tr><td style="text-align:center"><b>' + sno + '</b></td><td style="text-align:left"><b>' + key.First_Name + '</b></td><td style="text-align:left"><b>' + key.First_Name1 + '</b></td><td style="text-align:center">' + (key.pc_year) + ' - ' + (key.pc_year + 1) + '</td><td style="text-align:center">' + DR + '</td><td style="text-align:center">' + FIELD + '</td><td style="text-align:center">' + CPC + '</td><td style="text-align:center">' + fee + '</td><td style="text-align:center">' + FC + '</td></tr>';
					}
					if ($("#drpType").val() == 72) {
						body += '<tr><td style="text-align:center"><b>' + sno + '</b></td><td style="text-align:left"><b>' + key.First_Name + '</b></td><td style="text-align:center">' + monthNames[pc_month - 1] + '</td><td style="text-align:center">' + key.pc_year + '</td><td style="text-align:left">' + key.First_Name1 + '</td><td style="text-align:center">' + TC + '</td><td style="text-align:center">' + TP + '</td><td style="text-align:center">' + RF + '</td><td style="text-align:center">' + fee + '</td><td style="text-align:center">' + FC + '</td></tr>';
					}
