...
$('#tblIT_INDIVIDUAL tbody').append('<tr><td rowspan="2" colspan="2"><table class="table table-bordered table_ITI" height="138px" style="width: 107%!important;"><tr><td style="text-align:left;font-size: 20px;    width: 25%;">FEE</td><td width="25%" style="font-size: 17px;">' + feecollection + '</td></tr><tr><td style="text-align:left;font-size: 20px;    width: 25%;">Collected</td><td width="25%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr><tr><td> <table height="60px"><tr></tr></table> </td></tr>');
					sno++;
...
$('#tblgstCompounding').append('<tbody><tr><td rowspan="2" colspan="2"><table class="table table-bordered table_comp" height="138px" style="width: 107%!important;"><tr><td style="text-align:left;font-size: 20px;    width: 25%;">FEE</td><td width="25%" style="font-size: 17px;">' + feecollection + '</td></tr><tr><td style="text-align:left;font-size: 20px;    width: 25%;">Collected</td><td width="25%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr><tr><td> <table  height="60px"><tr></tr></table> </td></tr></tbody>');
