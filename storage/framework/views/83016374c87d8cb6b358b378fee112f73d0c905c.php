...
-->
											...
											<tbody>
                                                ...
                                                $cf=0;
                                                $countfee=0;
                                                if($row['complete'][0]->Br!=NULL){
                                                  $Br= $row['complete'][0]->Br;
                                                }
                                                 if($row['complete'][0]->ta!=NULL){
                                                  $ta= $row['complete'][0]->ta;
                                                } 
                                                if($row['complete'][0]->gstr3b!=NULL){
                                                  $gstr3b= $row['complete'][0]->gstr3b;
                                                }
                                                if($row['complete'][0]->gstr1!=NULL){
                                                  $gstr1= $row['complete'][0]->gstr1;
                                                }
                                                 if($row['complete'][0]->gstr2!=NULL){
                                                  $gstr2= $row['complete'][0]->gstr2;
                                                }  
                                                if($row['complete'][0]->gstr3!=NULL){
                                                  $gstr3= $row['complete'][0]->gstr3;
                                                } 
                                                if($row['complete'][0]->gstr4!=NULL){
                                                  $gstr4= $row['complete'][0]->gstr4;
                                                }
                                                if($row['complete'][0]->cf!=NULL){
                                                  $cf= $row['complete'][0]->cf;
                                                }
                                                if($row['complete'][0]->countfee!=NULL){
                                                  $countfee= $row['complete'][0]->countfee;
                                                }
                                                ?>
     ...
     $("#loading").hide();
			...
			success: function(data) {
				...
				$.each(data['company'], function(i, key) {
					...
					var fc = '<td>' + key.complete[0]['countfee'] + '</td>';
					...
					if ($('#drpStatus').val() == 2) {
						...
						br = '<td>' + (key.complete[0]['Br']) + '</td>';
						ta = '<td>' + (key.complete[0]['ta']) + '</td>';
						gstr3b = '<td>' + (key.complete[0]['gstr3b']) + '</td>';
						gstr1 = '<td>' + (key.complete[0]['gstr1']) + '</td>';
						gstr2 = '<td>' + (key.complete[0]['gstr2']) + '</td>';
						gstr3 = '<td>' + (key.complete[0]['gstr3']) + '</td>';
						gstr4 = '<td>' + (key.complete[0]['gstr4']) + '</td>';
						fc = '<td>' + (key.complete[0]['countfee']) + '</td>';
						cf = '<td>' + (key.complete[0]['cf']) + '</td>';
						console.log(key);
					}
