    ...
    $totaltFee=$totaltFee+($compnayfeetotal+$customerfeetotal);
                                 ...
                                 <tfoot style="background: #e6e3e3;">
                                            <tr>
                                                 ...
                                                 <?php if($data['groupid']==12){ ?>
                                       <td colspan="1" style="text-align:center"><b>TOTAL</b></td>                                 <?php }else{ ?>
                                       <td colspan="1" style="text-align:center"><a href="company_details_all?Date=<?= $data["date"]?>"><b>TOTAL</b></a></td>
                                        <?php }?>
   ...
   var customerfeetotal =  key[0].customerfeetotal;
    ...
    totaltdsconcern=parseInt(totaltdsconcern)+parseInt(TDScccount);
     totaltFee=parseInt(totaltFee)+parseInt(compnayfeetotal)+parseInt(customerfeetotal);
        ...
        $('#tblGst tfoot').append(' <tr><td colspan="1" style="text-align:center"><a href="company_details_all?Date='+date+'"><b>TOTAL</b></a></td><td style="text-align:center"><b>'+totalgstregular+'</b></td><td style="text-align:center">'+totalgstcompounding+'</td><td style="text-align:center">'+totalitindividual+'</td><td style="text-align:center">'+totalitconcern+'</td><td style="text-align:center">'+totaltdsindividual+'</td><td style="text-align:center">'+totaltdsconcern+'</td><td style="text-align:center">'+totaltFee+'</td><td style="text-align:center">'+(totalgstregular+totalgstcompounding+totalitindividual+totalitconcern+totaltdsindividual+totaltdsconcern)+'</td></tr>');
