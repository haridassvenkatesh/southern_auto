                                    ...
                                    <form class="dropzone dropzone-custom needsclick add-professors" id="employee">
                                       <div class="row">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											...
											?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="employee_unique_id" id="employee_unique_id" type="text" class="form-control" placeholder="Employee Id" value="<?php echo e($data['employee_details'][0]->employee_unique_id); ?>">
                                                </div>  
                                                
                                                
                                             <div class="form-group">
                                                <label>Phone No</label>
                                                <input name="phone_no1" id="phone_no1" type="text" class="form-control" placeholder="Phone No" value="<?php echo e($data['employee_details'][0]->phone_no1); ?>">
                                             </div>
                                             <div class="form-group">
                                                <label>Additional Phone No</label>
                                                <input name="phone_no2" id="phone_no2" type="text" class="form-control" placeholder="Additional Phone No" value="<?php echo e($data['employee_details'][0]->phone_no2); ?>">
                                             </div>
                                             <div class="form-group">
                                                <label>Email Id</label>
                                                <input name="email_id" id="email_id" type="text" class="form-control" placeholder="Email Id" value="<?php echo e($data['employee_details'][0]->email); ?>">
                                             </div>
                                          ...
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input name="dob" id="dob" type="text" class="form-control" placeholder="DOB" value="<?php echo e($data['employee_details'][0]->dob); ?>">
                                             </div>
                                             <div class="form-group">
                                                  <label>
                                                 DOJ
                                                 </label>
                                                <input name="doj" id="doj" type="text" class="form-control" placeholder="DOJ" value="<?php echo e($data['employee_details'][0]->doj); ?>">
                                             </div>
                                             <div class="form-group res-mg-t-15">
                                                 <label>
                                                 Address
                                                 </label>
                                                <textarea name="address" id="address" placeholder="Address" style="height: 115px;" ><?php echo e($data['employee_details'][0]->address); ?></textarea>
                                             </div>
                                             ...
                                             <div class="form-group res-mg-t-15">
                                                ...
                                                <textarea name="remarks" id="remarks" placeholder="Remarks" style="height: 115px;"><?php echo e($data['employee_details'][0]->remark); ?></textarea>
                                             </div>
                                                 <div class="form-group res-mg-t-15">
                                                  <label>
