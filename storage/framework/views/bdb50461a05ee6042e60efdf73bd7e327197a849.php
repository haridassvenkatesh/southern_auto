                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            ...
                            <center>
                                <div class="muted pull-center">GST-COMPOUNDING - Employee Mapping</div>
                            </center>
                        </div>
...
-->
                                    ...
                                    <div>
                                        <legend>Compounding Mapping</legend>
                                        <center>
                                            <table>
                    ...
                    success: function(data) {
                        if ($.isEmptyObject(data.error)) {
                            ...
                            swal({
                                ...
                                function() {
                                    window.location.href = 'employee_mapping_compounding';
                                });
