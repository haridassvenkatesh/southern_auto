                                    ...
                                    <table class="table table-bordered" id="tblgstregular">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">GSTR 2</th>
                                                <th style="text-align: center;">GSTR 3</th>
                                    ...
                                    <table class="table table-bordered" id="tblgstCompounding">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Tally Accounted</th>
                                                <th style="text-align: center;">Fees Collection</th>
                                                <?php if((date('m') - 1) == 0 || date('m') == 3 || date('m') == 6 || date('m') == 9) { ?>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <?php $sno = 1; ?> <?php $__currentLoopData = $data['gstCompoundingDetails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $__currentLoopData = $r; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <table class="table table-bordered" id="tblITIndividual">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;">S.No</th>
                                                <th style="text-align: center;">Employee</th>
                                                <th style="text-align: center;">Totan Customer</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <?php $sno = 1; ?> <?php $__currentLoopData = $data['gstITIndividualDetails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $__currentLoopData = $r; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <table class="table table-bordered" id="tblITConcern">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <?php $sno = 1; ?> <?php $__currentLoopData = $data['gstITConcernDetails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $__currentLoopData = $r; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <table class="table table-bordered" id="tbltdsINDIVIDUAL">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <?php $sno = 1; ?> <?php $__currentLoopData = $data['gstTSDIndividualDetails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $__currentLoopData = $r; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <table class="table table-bordered" id="tblTDSConcern">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <?php $sno = 1; ?> <?php $__currentLoopData = $data['gstTSDConcernDetails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $__currentLoopData = $r; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (tax == 7) {
                    ...
                    $('#tblgstregular tfoot').append('<tr><td colspan="2"><center><b>TOTAL</b></center></td><td style="text-align:center"><b>' + totalCompany + '<b></td><td style="text-align:center"><b>' + totalBR + '<b></td><td style="text-align:center"><b>' + totalTA + '<b></td><td style="text-align:center"><b>' + totalGSTR3B + '<b></td><td style="text-align:center"><b>' + totalGSTR1 + '<b></td><td style="text-align:center"><b>' + totalGSTR2 + '<b></td><td style="text-align:center"><b>' + totalGSTR3 + '<b></td><td style="text-align:center"><b>' + totalFA + '<b></td></tr>');
                    ...
                    if (n == 1 || n == 2 || n == 3 || n == 4) {
                        $('#tblgstCompounding').append('<thead><th style="text-align:center">S.No</th><th style="text-align:center">Employee</th><th style="text-align:center">Total Company</th><th style="text-align:center">Bill Received</th><th style="text-align:center">Tally Accounted</th><th style="text-align:center">Fees Collection</th><th style="text-align:center">GSTR 4</th></thead>');
                    } else {
                        $('#tblgstCompounding').append('<thead><th style="text-align:center">S.No</th><th style="text-align:center">Employee</th><th style="text-align:center">Total Company</th><th style="text-align:center">Bill Received</th><th style="text-align:center">Tally Accounted</th><th style="text-align:center">Fees Collection</th></thead>');
                    }
                    ...
                    $.each(data['gstRegularDetails'], function(i, key) {
                        ...
                        if (n == 1 || n == 2 || n == 3 || n == 4) {
                            $('#tblgstCompounding').append('<tr><td><b>' + sno + '</b></td><td><b>' + key[0].varName + '</b></td><td style="text-align:center">' + key[0].countCompany + '</td><td style="text-align:center">' + countBR + '</td><td style="text-align:center">' + countTA + '</td><td style="text-align:center">' + countFC + '</td><td style="text-align:center">' + countGSTR4 + '</td></tr>');
                        } else {
                            $('#tblgstCompounding').append('<tr><td><b>' + sno + '</b></td><td><b>' + key[0].varName + '</b></td><td style="text-align:center">' + key[0].countCompany + '</td><td style="text-align:center">' + countBR + '</td><td style="text-align:center">' + countTA + '</td><td style="text-align:center">' + countFC + '</td></tr>');
                        }
                        //alert(sno);
                        //console.log(key);
                    ...
                    if (n == 1 || n == 2 || n == 3 || n == 4) {
                        $('#tblgstCompounding').append('<tfoot style="background: #e6e3e3;"><tr><td colspan = "2"> <center><b> TOTAL </b></center></td ><td  style="text-align:center"> <b>' + totalCompany + '</b></td> <td   style="text-align:center"> <b>' + totalBR + '</b> </td> <td  style="text-align:center"> <b>' + totalTA + '</b> </td><td  style="text-align:center">' + totalGSTR4 + '</td > <td style="text-align:center"> <b>' + totalFA + '</b></td></tr></tfoot> ');
                    } else {
                        $('#tblgstCompounding').append('<tfoot style="background: #e6e3e3;"><tr><td colspan="2"><center><b>TOTAL</b></center></td><td style="text-align:center"><b>' + totalCompany + '</b></td><td style="text-align:center"><b>' + totalBR + '</b></td><td style="text-align:center"><b>' + totalTA + '</b></td><td style="text-align:center"><b>' + totalFA + '</b></td></tr></tfoot>');
                    }
                }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data['gstTSDDetails'], function(i, key) {
                    ...
                    totalCompany = totalCompany + countCompany;
                    ...
                    $('#' + tblName).append('<tr><td><b>' + sno +
                        '</b></td><td><b>' + employeeName + '</b></td><td style="text-align:center">' + countCompany + '</td><td style="text-align:center">' + countTC + '</td><td style="text-align:center">' + countTP + '</td><td style="text-align:center">' + countRF + '</td><td style="text-align:center">' + countFC + '</td></tr>');
                ...
                $('#' + tblName).append('<tfoot style="background: #e6e3e3;"><tr><td colspan="2"><center><b>TOTAL</b></center></td><td style="text-align:center"><b>' + totalCompany + '</b></td><td style="text-align:center"><b>' + totalTC + '</b></td><td style="text-align:center"><b>' + totalTP + '</b></td><td style="text-align:center"><b>' + totalRF + '</b></td><td style="text-align:center"><b>' + totalFC + '</b></td></tr></tfoot>');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data['gstITDetails'], function(i, key) {
                    ...
                    $('#' + tblName).append('<tr><td><b>' + sno +
                        '</b></td><td><b>' + employeeName + '</b></td><td style="text-align:center">' + countCompany + '</td><td style="text-align:center">' + countDR + '</td><td style="text-align:center">' + countFIELD + '</td><td style="text-align:center">' + countCPC + '</td><td style="text-align:center">' + countFC + '</td></tr>');
                ...
                $('#' + tblName).append('<tfoot style="background: #e6e3e3;"><tr><td colspan="2"><center><b>TOTAL</b></center></td><td style="text-align:center"><b>' + totalCompany + '</b></td><td style="text-align:center"><b>' + totalDR + '</b></td><td style="text-align:center"><b>' + totalFIELD + '</b></td><td style="text-align:center"><b>' + totalCPC + '</b></td><td style="text-align:center"><b>' + totalFC + '</b></td></tr></tfoot>');
