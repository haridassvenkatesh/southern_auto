...
<br/><br/>
                                    ...
                                    <tr>
                                        ...
                                        <table class="table table-bordered table_gst" height="138px">
  <tr>
      <td style="text-align:left;font-size: 25px;">Fee</td>
    <td></td>
  </tr>
  <tr>
    <td style="text-align:left;font-size: 25px;">Collected</td>
    <td></td>
...
">
							...
							<div class="block-content collapse in">
                                ...
                                <tr>    <td style="font-size:15px;"><b>Finanacial Year</b></td>
...
-->
                                      ...
                                      <tr>
                                        ...
                                        <table class="table table-bordered table_comp" height="60px">
                                           ...
                                           <td rowspan="2" colspan="2">
                                        <table class="table table-bordered table_comp" height="138px">
  <tr>
      <td style="text-align:left;font-size: 25px;">Fee</td>
    <td></td>
  </tr>
...
<!--
                                        <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>Document Received</b></td>
                                        <td>
                                        </td>
                                        </tr> <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>Field</b></td>
                                        <td></td>
                                        </tr>
                                      
                                        <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>CPC</b></td>
                                        <td></td> </tr> 
                                        <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>Fee</b></td>
                                        <td></td> </tr> <tr>
...
-->
                                    ...
                                    <tr>
                                        ...
                                        <table class="table table-bordered table_ITI" height="60px">
                                            <tr>
                                            <td width="50%" style="font-size: 20px;width: 1031px;">D/R</td>
                                            <td width="50%" style="font-size: 17px;"></td>
                                            </tr>
                                        </table>
                                          </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <table class="table table-bordered table_ITI" height="60px">
                                            <tr>
                                            <td width="50%" style="font-size: 20px; width: 1031px;">Field</td>
                                            <td width="50%" style="font-size: 17px;"></td>
                                            </tr>
                                        </table>
                                          </td>
                                        ...
                                        <table class="table table-bordered table_ITI" height="60px">
                                           ...
                                           <td rowspan="2" colspan="2">
                                        <table class="table table-bordered table_ITI" height="138px">
  <tr>
      <td style="text-align:left;font-size: 25px;width: 1000px;">Fee</td>
    <td></td>
  </tr>
  <tr>
    <td style="text-align:left;font-size: 25px;width: 1000px;">Collected</td>
    <td></td>
						...
						<div class="block" style="margin-top: 40px;">
							...
							<div class="block-content collapse in">
								<div class="span12">
                                    ...
                                    <tr>
                                        <td style="font-size:15px;"><b>Customer Name</b></td>
                                        <td><input type="text" id="IT_CONCERN" placeholder="Customer Name" name="IT_CONCERN"  style="height:20px !important;width:90% !important;"/></td>
                                        <td style="font-size:15px;"><b>proprietor</b></td>
								...
								<div class="span12" style="margin-left:0px;">
                                    ...
                                    <tr>
                                        ...
                                        <table class="table table-bordered table_ITC" height="60px">
                                           ...
                                           <td rowspan="2" colspan="2">
                                        <table class="table table-bordered table_ITC" height="138px">
  <tr>
      <td style="text-align:left;font-size: 25px;width: 1000px;">Fee</td>
    <td></td>
  </tr>
...
<!--
                                            <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>T/C</b></td>
                                        <td></td> </tr> <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>T/P</b></td>
                                        <td></td>
                                        </tr>
                                      
                                        <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>R/F</b></td>
                                        <td></td> </tr> 
                                        <tr>
                                        <td style="text-align:left;font-size: 25px;"><b>Fee</b></td>
                                        <td></td> </tr> <tr>
...
-->
                                        ...
                                        <table class="table table-bordered table_TDSI" height="60px">
                                            <tr>
                                            <td width="50%" style="font-size: 20px;width: 1031px;">T/C</td>
                                            <td width="50%" style="font-size: 17px;"></td>
                                            </tr>
                                        </table>
                                          </td>
                                    ...
                                    <tr>
                                        ...
                                        <table class="table table-bordered table_TDSI" height="60px">
                                            <tr>
                                            <td width="50%" style="font-size: 20px; width: 1031px;">T/P</td>
                                            <td width="50%" style="font-size: 17px;"></td>
                                            </tr>
                                        </table>
                                          </td>
                                        ...
                                        <table class="table table-bordered table_TDSI" height="60px">
                                           ...
                                           <td rowspan="2" colspan="2">
                                        <table class="table table-bordered table_TDSI" height="138px">
  <tr>
      <td style="text-align:left;font-size: 25px;width: 1000px;">Fee</td>
    <td></td>
  </tr>
								...
								<div class="span12" style="margin-left:0px;">
                                    ...
                                    <tr>
                                        ...
                                        <table class="table table-bordered table_TDSC" height="60px">
                                           ...
                                           <td rowspan="2" colspan="2">
                                        <table class="table table-bordered table_TDSC" height="138px">
  <tr>
      <td style="text-align:left;font-size: 25px;width: 1000px;">Fee</td>
    <td></td>
  </tr>
...
//                    $('#tblIT_INDIVIDUAL tbody').append('<tr><td style="text-align:left;font-size: 25px;"><b>Document Received</b></td><td style="font-size: 20px;">' + dr + '</td></tr><tr><td style="text-align:left;font-size: 25px;"><b>Field</b></td><td style="font-size: 20px;">' + field + '</td></tr><tr><td style="text-align:left;font-size: 25px;"><b>CPC</b></td><td style="font-size: 20px;">' + cpc + '</td> </tr><tr><td style="text-align:left;font-size: 25px;"><b>Fee</b></td><td style="font-size: 20px;">' + key.Actual_Fee + '</td> </tr> <tr><td style="text-align:left;font-size: 25px;"><b>Collected</b></td><td style="font-size: 20px;">' + FC + '</td></tr>');  
                    
                    
                    $('#tblIT_INDIVIDUAL tbody').append('<tr><td><table class="table table-bordered table_ITI" height="60px"><tr><td width="50%" style="font-size: 20px;width: 1031px;">D/R</td><td width="50%" style="font-size: 17px;">' + dr + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_ITI" height="60px"><tr><td width="50%" style="font-size: 20px; width: 1031px;">Field</td><td width="50%" style="font-size: 17px;">' + field + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_ITI" height="60px"><tr> <td width="50%" style="font-size: 20px; width: 1031px;">CPC</td><td width="50%" style="font-size: 17px;">' + cpc + '</td></tr></table></td></tr><tr><td rowspan="2" colspan="2"><table class="table table-bordered table_ITI" height="138px"><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Fee</td><td width="50%" style="font-size: 17px;">' + key.Actual_Fee + '</td></tr><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Collected</td><td width="50%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr> ');
					sno++;
...
//                     $('#tblIT_CONCERN tbody').append('<tr><td style="text-align:left;font-size: 25px;"><b>Document Received</b></td><td style="font-size: 20px;">' + dr + '</td> </tr> <tr><td style="text-align:left;font-size: 25px;"><b>Field</b></td><td style="font-size: 20px;">' + field + '</td></tr><tr><td style="text-align:left;font-size: 25px;"><b>CPC</b></td><td style="font-size: 20px;">' + cpc + '</td> </tr><tr><td style="text-align:left;font-size: 25px;"><b>Fee</b></td><td style="font-size: 20px;">' + key.Actual_Fee + '</td> </tr> <tr><td style="text-align:left;font-size: 25px;"><b>Collected</b></td><td style="font-size: 20px;">' + FC + '</td></tr>');
                    
                      $('#tblIT_CONCERN tbody').append('<tr><td><table class="table table-bordered table_ITC" height="60px"><tr><td width="50%" style="font-size: 20px;width: 1031px;">D/R</td><td width="50%" style="font-size: 17px;">' + dr + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_ITC" height="60px"><tr><td width="50%" style="font-size: 20px; width: 1031px;">Field</td><td width="50%" style="font-size: 17px;">' + field + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_ITC" height="60px"><tr> <td width="50%" style="font-size: 20px; width: 1031px;">CPC</td><td width="50%" style="font-size: 17px;">' + cpc + '</td></tr></table></td></tr><tr><td rowspan="2" colspan="2"><table class="table table-bordered table_ITC" height="138px"><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Fee</td><td width="50%" style="font-size: 17px;">' + key.Actual_Fee + '</td></tr><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Collected</td><td width="50%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr> ');
...
//						FC = '<div id="FCi" style="display:block"> <label class="switch"><input class="switch-input" type="checkbox" id="chkFCi" onchange="update_TDS_INDIVIDUAL(70,' + TDS_INDIVIDUAL + ')"/>					<span class="switch-label" data-on="Yes" data-off="No" style="background: #3c9faf;"></span> <span class="switch-handle"></span> </label></div> <div id="FCi_1" style="display:none"> ' + d + '</div>';
                      ...
                      $('#tbltdsI tbody').append('<tr><td><table class="table table-bordered table_TDSI" height="60px"><tr><td width="50%" style="font-size: 20px;width: 1031px;">T/C</td><td width="50%" style="font-size: 17px;">' + tc + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_TDSI" height="60px"><tr><td width="50%" style="font-size: 20px; width: 1031px;">T/P</td><td width="50%" style="font-size: 17px;">' + tp + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_TDSI" height="60px"><tr> <td width="50%" style="font-size: 20px; width: 1031px;">R/F</td><td width="50%" style="font-size: 17px;">' + rf + '</td></tr></table></td></tr><tr><td rowspan="2" colspan="2"><table class="table table-bordered table_TDSI" height="138px"><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Fee</td><td width="50%" style="font-size: 17px;">' + key.Actual_Fee + '</td></tr><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Collected</td><td width="50%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr> ');
                    
                    
//                    $('#tbltdsI tbody').append('<tr><td style="text-align:left;font-size: 25px;"><b>T/C</b></td><td style="font-size: 20px;">' + tc + '</td> </tr> <tr><td style="text-align:left;font-size: 25px;"><b>T/P</b></td><td style="font-size: 20px;">' + tp + '</td></tr><tr><td style="text-align:left;font-size: 25px;"><b>R/F</b></td><td style="font-size: 20px;">' + rf + '</td> </tr> <tr><td style="text-align:left;font-size: 25px;"><b>Fee</b></td><td style="font-size: 20px;">' + key.Actual_Fee  + '</td> </tr> <tr><td style="text-align:left;font-size: 25px;"><b>Collected</b></td><td style="font-size: 20px;">' + FC + '</td></tr>');
...
//						FC = '<div id="FCc" style="display:block"> <label class="switch"><input class="switch-input" type="checkbox" id="chkFCc" onchange="update_TDS_CONCERN(70,' + TDS_CONCERN + ')"/>					<span class="switch-label" data-on="Yes" data-off="No" style="background: #3c9faf;></span> <span class="switch-handle"></span> </label></div> <div id="FCc_1" style="display:none"> ' + d + '</div>';
                      ...
                      $('#tbltdsC tbody').append('<tr><td><table class="table table-bordered table_TDSC" height="60px"><tr><td width="50%" style="font-size: 20px;width: 1031px;">T/C</td><td width="50%" style="font-size: 17px;">' + tc + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_TDSC" height="60px"><tr><td width="50%" style="font-size: 20px; width: 1031px;">T/P</td><td width="50%" style="font-size: 17px;">' + tp + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_TDSC" height="60px"><tr> <td width="50%" style="font-size: 20px; width: 1031px;">R/F</td><td width="50%" style="font-size: 17px;">' + rf + '</td></tr></table></td></tr><tr><td rowspan="2" colspan="2"><table class="table table-bordered table_TDSC" height="138px"><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Fee</td><td width="50%" style="font-size: 17px;">' + key.Actual_Fee + '</td></tr><tr><td style="text-align:left;font-size: 25px;width: 50% !important;">Collected</td><td width="50%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr> ');
...
$('#tblgstregular tbody').append('<tr><td><table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">B/R</td><td width="25%" style="font-size: 17px;">' + BR + '</td></tr></table></td><td> <table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">GSTR 3B</td><td width="25%" style="font-size: 17px;">' + GSTR3B + '</td></tr></table></td></tr><tr><td><table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">T/A</td><td width="25%" style="font-size: 17px;">' + TA + '</td></tr></table></td><td> <table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">GSTR 1</td><td width="25%" style="font-size: 17px;">' + GSTR1 + '</td></tr></table></td></tr> <tr><td> <table class="table table-bordered table_gst" height="60px"><tr> <td width="25%" style="font-size: 20px;">Bank A/C</td> <td width="25%" style="font-size: 17px;">' + GSTR1 + '</td></tr> </table> </td><td rowspan="2" colspan="2"><table class="table table-bordered table_gst" height="138px"><tr><td style="text-align:left;font-size: 25px;    width: 25%;">Fee</td><td width="25%" style="font-size: 17px;">' + key.Actual_Fee + '</td></tr><tr><td style="text-align:left;font-size: 25px;    width: 25%;">Collected</td><td width="25%" style="font-size: 17px;">' + FC + '</td></tr></table></td></tr><tr><td> <table class="table table-bordered table_gst" height="60px"><tr><td width="25%" style="font-size: 20px;">Exp A/C</td><td width="25%" style="font-size: 17px;">' + GSTR3 + '</td></tr></table> </td></tr>');
...
//                            $('#tblgstCompounding').append('<tbody><tr><td style="text-align:left;font-size: 25px;"><b>Bill Received</b></td><td style="font-size: 20px;">'+ BR +'</td><td style="text-align:left;font-size: 25px;"><b>Tally Accounted</b></td><td  style="font-size: 20px;">' + TA + '</td></tr><tr><td style="text-align:left;font-size: 25px;"><b>Bank A/C</b></td><td  style="font-size: 20px;">' + GSTR2 + '</td><td style="text-align:left;font-size: 25px;"><b>EXP A/C</b></td><td  style="font-size: 20px;">' + GSTR3 + '</td></tr><tr><td style="text-align:left;font-size: 25px;"><b>Fee</b></td>><td  style="font-size: 20px;">' + key.Actual_Fee + '</td><td style="text-align:left;font-size: 25px;"><b>Collected</b></td><td  style="font-size: 20px;">' + FC + '</td></tr><tr><td style="text-align:left;font-size: 25px;"><b>GSTR4</b></td><td  style="font-size: 20px;">' + GSTR4 + '</td><td>-</td><td>-</td></tr></tbody>');
                            
                            
                            
                            $('#tblgstCompounding').append('<tbody><tr><td><table class="table table-bordered table_comp" height="60px"><tr><td width="25%" style="font-size: 20px;">B/R</td><td width="25%" style="font-size: 17px;">'+ BR +'</td></tr></table></td><td> <table class="table table-bordered table_comp" height="60px"><tr><td width="25%" style="font-size: 20px;">T/A</td>     <td width="25%" style="font-size: 17px;">'+ TA +'</td></tr></table></td></tr><tr><td><table class="table table-bordered table_comp" height="60px"><tr><td width="25%" style="font-size: 20px;">Bank A/C</td><td width="25%" style="font-size: 17px;">'+ GSTR2 +'</td></tr></table></td><td rowspan="2" colspan="2"><table class="table table-bordered table_comp" height="138px"><tr><td style="text-align:left;font-size: 25px;">Fee</td><td>'+  key.Actual_Fee +'</td></tr><tr><td style="text-align:left;font-size: 25px;">Collected</td><td>'+ FC +'</td></tr></table></td></tr><tr><td>      <table class="table table-bordered table_comp" height="60px"> <tr><td width="25%" style="font-size: 20px;">Exp A/C</td><td width="25%" style="font-size: 17px;">'+ GSTR3 +'</td></tr></table> </td></tr><tr><td><table class="table table-bordered table_comp" height="60px"><tr><td width="25%" style="font-size: 20px;">GSTR4</td><td width="25%" style="font-size: 17px;">'+ GSTR4 +'</td></tr></table></td></tr></tbody>');
                            

						} else {
//							$('#tblgstCompounding').append('<thead><tr><th rowspan="2">Bill Received</th><th rowspan="2">Tally Accounted</th><th rowspan="2">Bank A/C</th><th rowspan="2">EXP A/C</th><th colspan="2"> Fees Collection</th></tr><tr><th style="text-align:center">Fee</th>  <th style="text-align:center">Collected</th></tr></thead><tbody><tr><td style="text-align:center">' + BR + '</td><td style="text-align:center">' + TA + '</td><td style="text-align:center">' + GSTR2 + '</td><td style="text-align:center">' + GSTR3 + '</td><td style="text-align:center">' + key.Actual_Fee + '</td><td style="text-align:center">' + FC + '</td></tr></tbody>');
