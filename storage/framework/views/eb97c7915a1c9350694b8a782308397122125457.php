				...
				if (drpType == 7) {
					...
					$.each(data['company'], function(i, key) {
						...
						if (status == 2) {
							...
							$("#tblCompany tbody").append('<tr><td><b><a onclick="btnComplete(' + key.month + ')" >' + key.monthName + '</b></a></td><td>' + key.total + '</td><td>' + br + '</td><td>' + ta + '</td><td>' + gstr3b + '</td><td>' + gstr1 + '</td><td>' + gstr2 + '</td><td>' + gstr3 + '</td><td>' + cf + '</td><td>' + fc + '</td></tr>');
						}
					});
				}
				if (drpType == 8) {
